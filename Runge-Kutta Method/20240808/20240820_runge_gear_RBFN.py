...
# 式(1)の定義
def f_1(z1, z2, z1_dot, z2_dot, i_f, i_s, t):
...
# 式(2)の定義
def differential_equation_2(z1, z2, i_f, i_s):
    return -Z * i_s
...
if __name__ == "__main__":
    ...
    for i in range(num_steps):
        ...
        phi_next, i_s = forward_euler_step(phi_current, phi_prev, z1, z2, i_f, i_s, dt)
        # 更新
